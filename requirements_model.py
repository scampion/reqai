...
class BusinessProcess:
    def __init__(self, identifier, name, description, owner_id, department, inputs, outputs):
        self.identifier = identifier
        self.name = name
        self.description = description
    ...
    def __repr__(self):
        return (f"BusinessProcess(identifier={self.identifier}, name={self.name}, description={self.description}, "
                f"owner_id={self.owner_id}, department={self.department}, inputs={self.inputs}, outputs={self.outputs})")
...
class SystemsModel:
    ...
    def __repr__(self):
        return f"SystemsModel(systems={self.systems})"

class Requirement:
    def __init__(self, identifier, description, priority, type, source, stakeholder_ids, goal_ids, process_ids, system_ids=None):
        self.identifier = identifier
        self.description = description
        self.priority = priority
        self.type = type
        ...
        self.system_ids = system_ids if system_ids is not None else []
    ...
    def __repr__(self):
        return (f"Requirement(identifier={self.identifier}, description={self.description}, "
                ...
                f"process_ids={self.process_ids}, system_ids={self.system_ids})")
